...
RAND_EVENT_MINUTES_ITEMS_RANGE = (2, 3)
RAND_MATTER_RANGE = (2, 3)
...
DUMMY_FILE_URI = (
    ...
    # "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/does_not_exist_bro.pdf"
)
PERSON_PICTURE_URI = (
...
def _get_example_event() -> EventIngestionModel:
    ...
    sessions = [
        ...
        for i, session in enumerate(random.sample(SESSIONS, random.randint(1, 1)))
    ]
