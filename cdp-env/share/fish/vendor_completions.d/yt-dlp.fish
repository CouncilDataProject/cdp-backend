...
complete --command yt-dlp --long-option download-sections --description 'Download only chapters whose title matches the given regular expression. Time ranges prefixed by a "*" can also be used in place of chapters to download the specified range. Needs ffmpeg. This option can be used multiple times to download multiple sections, e.g. --download-sections "*10:15-15:00" --download-sections "intro"'
